...
description: >-
  Debug Better Go To File ranking against any local repository using the scoring
  CLI. Use when a user asks why a result ranked, wants to inspect top matches
  for a query, or wants to iterate on presets/overrides outside the VS Code
  extension host.
---
